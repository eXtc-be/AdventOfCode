...
# this version uses itertools.permutations to try and evaluate all possible combinations of components
# it runs decently fast with the example data (8 components) but impossibly slow with the real data (56)
...
if __name__ == "__main__":
    ...
    # # test Bridge.validate
    # for bridge in [
    #     Bridge([Component([0, 1]), ]),
    #     Bridge([Component([0, 1]), Component([1, 2]), ]),
    #     Bridge([Component([0, 1]), Component([2, 2]), ]),
    #     Bridge([Component([0, 1]), Component([0, 2]), ]),
    #     Bridge([Component([0, 1]), Component([10, 1]), ]),
    #     Bridge([Component([0, 1]), Component([10, 1]), Component([9, 10]), ]),
    #     Bridge([Component([0, 2]), Component([2, 2]), Component([2, 3]), Component([3, 5]), ]),
    #     Bridge([Component([0, 2]), Component([2, 2]), Component([3, 3]), Component([3, 5]), ]),
    #     Bridge([Component([0, 2]), Component([2, 3]), Component([2, 3]), Component([3, 5]), ]),
    # ]:
    #     print(bridge, bridge.validate())
