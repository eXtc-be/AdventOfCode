...
def _calc_destination(maps, value):
    for map in maps:
...
def _map_x_to_y(src, dst, value):
    ...
    retval = _calc_destination(map['map'], value)
...
if __name__ == "__main__":
    ...
    print(locations)  # should be [82, 43, 86, 35]

    print(f'End result: {min(locations)}')  # should be 35
