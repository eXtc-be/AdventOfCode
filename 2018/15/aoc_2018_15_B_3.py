...
from aoc_2018_15_A_extern_2 import (
    Grid,
    Type,
    ElfDied,
)
...
if __name__ == "__main__":
    ...
    #   Finished 'main' in 140 milliseconds
    # using test_data E:
    ...
    #   Finished 'main' in 427 milliseconds
    # using input data:
    #   End result: Elves win after 48 full rounds with 1127 hit points left and attack power 15. Score: 48 * 1127 = 54096
